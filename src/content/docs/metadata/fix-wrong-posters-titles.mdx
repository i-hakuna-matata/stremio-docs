...
4. See [Metadata Add-on Setup](/metadata/aiometadata-setup/) for details
...
- [Metadata Add-on Setup](/metadata/aiometadata-setup/) - Install alternative metadata sources
